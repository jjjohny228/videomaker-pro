...
class BrandKitService:
    ...
    def create_brand_kit(self, brand_kit_data: Dict[str, Any]) -> Optional[BrandKit]:
        ...
        try:
            ...
            brand_kit = BrandKit.create(
                ...
                subscribe_cta_path=brand_kit_data.get('subscribe_cta_path'),
                subscribe_cta_interval=brand_kit_data.get('subscribe_cta_interval', 120),
                voice=voice,
    ...
    def _serialize_brand_kit(self, brand_kit: BrandKit) -> Dict[str, Any]:
        ...
        return {
            ...
            'subscribe_cta_path': brand_kit.subscribe_cta_path,
            'subscribe_cta_interval': brand_kit.subscribe_cta_interval,
    ...
    def _load_voice_settings(self, brand_kit: BrandKit) -> Optional[Dict[str, Any]]:
        ...
        if brand_kit.voice:
            return {
                ...
                'language': brand_kit.voice.language,
    ...
    def _get_files_info(self, brand_kit: BrandKit) -> Dict[str, Dict[str, Any]]:
        ...
        file_paths = {
            ...
            'subscribe_cta': brand_kit.subscribe_cta_path,
